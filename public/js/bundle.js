    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return _axios.default.post('http://localhost:3000/api/v2003/users/login', {
            email: email,
            password: password
          });
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          console.log('first');
          _context2.next = 4;
          return _axios.default.get('http://localhost:3000/api/v2003/users/logout');
        case 4:
          res = _context2.sent;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaW1hZGthc3NlIiwiYSI6ImNtMnlqMDEwbDAxZzIyanM0YjRjMDZ3d3UifQ.hIgHQh5QDrfqw63MIXRZJA'; //
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>\n    ")).addTo(map);
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:3000/api/v2003/users/updateMyPassword' : 'http://localhost:3000/api/v2003/users/updateMe';
          _context.next = 4;
...
var updateForm = document.querySelector('.form-user-settings');
...
if (updateForm) {
  updateForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var btn, passwordCurrent, password, passwordConfirmation;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            btn = document.getElementById('btn--save-password');
